                                        ...
                                        {editing ? (
                                            <div className="flex items-center gap-3 justify-center lg:justify-start">
                                                <Input
                                                    ...
                                                    autoFocus
                                                />
                                                <Button className="h-12 shadow-lg shadow-primary/20 dark:text-white" onClick={handleSave} disabled={saving}>
                                                    {saving ? 'Saving...' : 'Save'}
                                                </Button>
                                                <Button className="h-12" variant="ghost" onClick={() => setEditing(false)}>
                                                    Cancel
                                                </Button>
                                            </div>
                                        ) : (
                                    ...
                                    <div className="w-full max-w-md pt-4">
                                        ...
                                        {nextLevel && (
                                            <p className="text-xs font-bold text-muted-foreground mt-3 uppercase tracking-widest text-center lg:text-left">
                                                {nextLevel.xpRequired - stats.xp} XP to unlock <span className={currentLevel.color}>{nextLevel.title}</span>
                                            </p>
                                        )}
                                    </div>
                                </div>
