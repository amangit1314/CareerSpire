...
const faqs = [
    {
        question: "What is Mocky?",
        answer: "Mocky is an AI-powered mock interview platform designed to help software engineers prepare for technical interviews with realistic simulations and actionable feedback."
    },
    {
    ...
    {
        question: "Can I use Mocky for mobile interview prep?",
...
export default function FAQPage() {
    return (
        <StaticPageLayout
            ...
            subtitle="Find answers to common questions about Mocky and how to get the most out of your practice."
        >
